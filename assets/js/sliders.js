const sliderJs = (options) => {
	...
	sl.prevBtn = document.querySelector(".bg-slider-prev");
	sl.nextBtn = document.querySelector(".bg-slider-next");
	sl.options = options;
	...
	sl.prevBtn.addEventListener("click", () => {
		sl.prev();
	});

	sl.nextBtn.addEventListener("click", () => {
		sl.next();
	});

	sl.drawDots();
	sl.drawProjectsButtons();
	sl.setActiveProject(0);

	return sl;
};

const smSliderJs = (options) => {
	let sl = {};
	const galleryPhoto = document.querySelector(".projects__small-gallery");
	const projectText = document.querySelector(".projects__text");
	const projectCity = document.querySelector(".projects__project-city");
	const projectSize = document.querySelector(".projects__project-size");
	const projectRepairTime = document.querySelector(
	...
	sl.drawButtons = () => {
		...
		galleryPhoto.innerHTML = buttonsHtml;
